...
/* Used to create custom header elements into autogenerated table of contents */
export function create_toc_element(header: string, href: string) {
    const elem = {
        type: "element",
        tagName: "li",
        properties: { className: "toc-item toc-item-h1" },
        children: [
            {
                type: "element",
                tagName: "a",
