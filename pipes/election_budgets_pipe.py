...
def preprocess_data():
    ...
    budgets_df = budgets_df.with_columns(
        ...
        pl.col("'Ehdokkaan mahdollisen tukiryhman nimi'")
        .str.strip_chars("'")
        .alias("support_group"),
        pl.lit(2023).alias("election_year"),
        pl.col("'Vaalikampanjan kulut yhteensa'")
        .str.strip_chars("'")
        .str.replace_all(r"\s", "")
        .replace("", "0")
        .str.replace(",", ".")
        .cast(pl.Float32)
        .alias("expenses_total"),
        pl.col("'Vaalikampanjan rahoitus yhteensa'")
        .str.strip_chars("'")
        .str.replace_all(r"\s", "")
        .replace("", "0")
        .str.replace(",", ".")
        .cast(pl.Float32)
        .alias("incomes_total"),
        pl.col("'2.1 Rahoitus sisaltaa omia varoja yhteensa'")
        .str.strip_chars("'")
        .str.replace_all(r"\s", "")
        .replace("", "0")
        .str.replace(",", ".")
        ...
        .cast(pl.Float32)
        .alias("income_loan"),
        pl.col("'2.3 Rahoitus sisaltaa yksityishenkiloilta saatua tukea yhteensa'")
        .str.strip_chars("'")
        .str.replace_all(r"\s", "")
        .replace("", "0")
        .str.replace(",", ".")
        .cast(pl.Float32)
        .alias("income_person"),
        pl.col("'2.4 Rahoitus sisaltaa yrityksilta saatua tukea yhteensa'")
        .str.strip_chars("'")
        .str.replace_all(r"\s", "")
        .replace("", "0")
        .str.replace(",", ".")
        .cast(pl.Float32)
        .alias("income_company"),
        pl.col("'2.5 Rahoitus sisaltaa puolueelta saatua tukea yhteensa'")
        .str.strip_chars("'")
        .str.replace_all(r"\s", "")
        .replace("", "0")
        .str.replace(",", ".")
        .cast(pl.Float32)
        .alias("income_party"),
        pl.col("'2.6 Rahoitus sisaltaa puolueyhdistyksilta saatua tukea yhteensa'")
        .str.strip_chars("'")
        .str.replace_all(r"\s", "")
        .replace("", "0")
        .str.replace(",", ".")
        .cast(pl.Float32)
        .alias("income_party_union"),
        pl.col("'2.8 Rahoitus sisaltaa valitettya tukea yhteensa'")
        .str.strip_chars("'")
        .str.replace_all(r"\s", "")
        .replace("", "0")
        .str.replace(",", ".")
        .cast(pl.Float32)
        .alias("income_forwarded"),
        pl.col("'2.7 Rahoitus sisaltaa muilta tahoilta saatua tukea yhteensa'")
        .str.strip_chars("'")
        .str.replace_all(r"\s", "")
        .replace("", "0")
        .str.replace(",", ".")
    ...
    budgets_df = budgets_df.join(mp_df, on=["first_name", "last_name"], how="inner")
